...
public class JavaStdinandStdoutI {
    ...
    public static void main(String[] args){
        ...
        int enteredint1 = scan.nextInt();
        int enteredint2 = scan.nextInt();
        int enteredint3 = scan.nextInt();
        scan.close();
        System.out.println(enteredint1);
        System.out.println(enteredint2);
        System.out.println(enteredint3);
    }
}
